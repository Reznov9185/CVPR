function edges = det_canny_edge(im,thres_high,thres_low) %edge detection function
...
for i=1:size(edges,1)-1 %for each column
    for j=1: size(edges,2)-1 %for each row
